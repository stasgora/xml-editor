...
import dev.sgora.xml_editor.Main;
...
public class ValidationService {
	...
	public void validateXML() {
		try {
			...
			JAXBElement<AccountStatement> model = (JAXBElement<AccountStatement>) unmarshaller.unmarshal(new StreamSource(Main.class.getResourceAsStream("/xml/account-statement-1.xml")));
